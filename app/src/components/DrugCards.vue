<template>
  <div>
    <div class="card">
      <h2></h2>
      <img :src="drug.image" :alt="drug.function" class="card-img" />

      <div
        class="card w-[90%] sm:w-[50%] md:w-[33%] lg:w-[15%] h-auto rounded-3xl flex flex-col items-center justify-around m-4 bg-blue-200"
      >
